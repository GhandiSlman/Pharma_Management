...
import 'package:pharma_man/controllers/auth/logout_controlller.dart';
...
class HomeAsAdmin extends StatelessWidget {
  final BestSellingController controller = Get.put(BestSellingController());
  DrawController controller2 = Get.put(DrawController());
  ProductController controller3 = Get.put(ProductController());
  LogOutController controller4 = Get.put(LogOutController());
  @override
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: CustomText(
                      ...
                      wieght: FontWeight.bold,
                      color: AppColor.black),
                  onTap: () => Get.toNamed(AppRoute.expiredProduct),
                ),
                ListTile(
                  ...
                  title: CustomText(
                      ...
                      wieght: FontWeight.bold,
                      color: AppColor.black),
                  onTap: () => Get.toNamed(AppRoute.allDonation),
                ),
                ListTile(
